...
<html lang="en">
    ...
    <body style="overflow: hidden;">
        ...
        <div class="alert alert-success alert-dismissible fade show position-absolute alert-css" style="right: -445px;" role="alert">
            <h6>
                <strong>Holy guacamole!</strong>
            </h6> 
            <p>You should check in on some of those fields below.</p>
        ...
        <div class="alert alert-danger alert-dismissible fade show position-absolute alert-css" style="right: -445px;" role="alert">
            <h6>
                <strong>Holy guacamole!</strong>
            </h6> 
            <p>You should check in on some of those fields below.</p>
